...
function run() {
  ...
  document.getElementById('ouchie').innerHTML = germsearch + ", you have definitely been Butthurt";
  document.getElementById('intro').innerHTML = ("<div class=\"media\"><div class=\"media-left\"> <img class\=\"media-object\" src\= " + randPix + " alt=\"...\"></div> " + "<div class=\"media-body\">" + "<p>Dear sweet, precious " + germsearch + " it appears that " + bully + " has placed a hurting on your butt. Please find the nearest blankey and snuggle with it.  Meanwhile, ima hang with " + bully + " because honestly you're driving me nuts with your " + flipSwitch + "</p></div></div><br>");
